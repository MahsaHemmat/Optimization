function [eta]= etaFinder(Ps1,Ps2,Ps3,Ps4)
mdot = 320000/3600;
%% Points Info
%point1
P1 =9.3*1e6;
...
%point 7 
P7 = Ps3;
T7=py.CoolProp.CoolProp.PropsSI('T','P',Ps4,'Q',0,'Water');
...
%point10
P10 = P1;
T10=py.CoolProp.CoolProp.PropsSI('T','P',Ps2,'Q',0,'Water');
...
%extraction steam
hs1 = py.CoolProp.CoolProp.PropsSI('H','P',Ps1,'S',s2,'Water');
hs2 = py.CoolProp.CoolProp.PropsSI('H','P',Ps2,'S',s2,'Water');
hs3 = py.CoolProp.CoolProp.PropsSI('H','P',Ps3,'S',s2,'Water');
hs4 = py.CoolProp.CoolProp.PropsSI('H','P',Ps4,'S',s2,'Water');
%% Calculation
% Boiler
Qh = mdot*(h2-h1);
%HP heater
